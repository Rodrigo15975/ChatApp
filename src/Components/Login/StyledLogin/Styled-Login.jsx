...
export const MainLogin = styled.main` min-height: 100vh;  max-width: 120rem;  position: relative;  display: flex;  overflow: hidden;  align-items: center;  justify-content: center;  padding: 0 0rem 0 1rem;
  ...
  `};
`;
export const ConteinerLogin = styled.div`  flex: 0 1 44rem;  min-height: 52rem;  outline: #6663ff 0.3rem solid;  border-radius: 0.4rem;  padding: 1rem;`;
export const ConteinerImgPhone = styled.div`
  flex: 0 1 35rem;  min-height: 35rem;  display: flex;  align-items: center;  justify-content: start;  img {
